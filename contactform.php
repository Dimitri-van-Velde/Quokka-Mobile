            ...
            <article class="form-container">
                ...
                ?>
                    <form class="contact" action="php-includes/contact.inc.php" method="post">
                        ...
                        <fieldset>
                            <input placeholder="Uw Emailadres" name="email" id="email" type="email" tabindex="3" required value="<?php echo $_SESSION["email"]; ?>">
                        </fieldset>
                        <fieldset>
                            <input placeholder="Uw Telefoonnummer" name="tel" id="tel" type="tel" pattern="[0-9]{10}" tabindex="4" required value="<?php echo $_SESSION["phonenumber"]; ?>">
                        </fieldset>
                        <fieldset>
                ...
                ?>
                    <form class="contact" action="php-includes/contact.inc.php" method="post">
                        ...
                        <fieldset>
                            <input placeholder="Uw Telefoonnummer" name="tel" id="tel" type="tel" pattern="[0-9]{10}" tabindex="4" required>
                        </fieldset>
                        <fieldset>
                            <h3 class="beoordeling-h3">Beoordeling: </h3>
                            <span class="star-rating star-5">
