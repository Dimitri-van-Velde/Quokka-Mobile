                ...
                ?>
                    <form action="php-includes/signup.inc.php" class="signup-form" method="post">
                        <fieldset class="signup-inlog">
                            ...
                            <fieldset><input type="password" name="password" id="password" placeholder="Wachtwoord (minimaal 8 karakters)" pattern=".{8,}" tabindex="2" maxlength="20"></fieldset>
                            <fieldset><input type="password" name="passwordrepeat" id="passwordrepeat" placeholder="Herhaal Wachtwoord" pattern=".{8,3}" tabindex="3" maxlength="20">
                            </fieldset>
                        </fieldset>
