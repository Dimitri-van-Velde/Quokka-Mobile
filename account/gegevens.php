        ...
        <section class="account">
            <article class="account-list">
                <ul>
                    ...
                    <li><a href="gegevens.php" class="account-current-page"><svg version="1.1" viewBox="0 0 14 14" aria-hidden="true"
                    ...
                    <li><a href="bestellingen.php"><svg version="1.1" viewBox="0 0 14 14" aria-hidden="true"
                                class="account-svg" focusable="false">
